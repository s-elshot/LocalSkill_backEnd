-- INSERT INTO customer (customer_id, password, enabled) VALUES ('user','', TRUE);
-- INSERT INTO customer (customer_id, password, enabled) VALUES ('admin','$2a$10$wPHxwfsfTnOJAdgYcerBt.utdAvC24B/DWfuXfzKBSDHO0etB1ica', TRUE);
-- INSERT INTO customer (customer_id, password, enabled) VALUES ('peter', '$2a$10$wPHxwfsfTnOJAdgYcerBt.utdAvC24B/DWfuXfzKBSDHO0etB1ica', TRUE);
--
-- INSERT INTO authorities (customer_id, authority) VALUES ('user', 'ROLE_USER');
-- INSERT INTO authorities (customer_id, authority) VALUES ('admin', 'ROLE_USER');
-- INSERT INTO authorities (customer_id, authority) VALUES ('admin', 'ROLE_ADMIN');
-- INSERT INTO authorities (customer_id, authority) VALUES ('peter', 'ROLE_ADMIN');
-- INSERT INTO authorities (customer_id, authority) VALUES ('peter', 'ROLE_USER');
...
--
--
insert into customer(id,password, first_name, last_name, email, area_code, user_role, enabled,  city, customer_guild)
values (1,'$2y$12$ORMqR3napnNSGA.vI1Xgmubi4iQRmoaB3pH52wugGiq8t6v.d3A4e','Stephan', 'Elshot', 'selshot@gmail.com', '1946AL','GUILDER',TRUE,'Beverwijk','SALES');
insert into customer(id,first_name, last_name, email, area_code, enabled, user_role, city, customer_guild )
values (2,'Susanne', 'Bijwaard', 'susannebijwaard@yahoo.com', '1946AL',TRUE, 'GUILDER', 'Beverwijk','SALES');
...
--
insert into customer(id, password, username, first_name, last_name, email, area_code, enabled,user_role,  city)
values (3,'Michel','Michel','Michel', 'Lalmohamed', 'mlalmohamed@gmail.com', '1946AL',TRUE,'CUSTOMER','Beverwijk');
insert into customer(id, password,username, first_name, last_name, email, area_code, enabled, user_role, city, customer_guild )
values (4,'Zhara','Zhara','Zhara', 'Lalmohamed', 'susannebijwaard@yahoo.com', '1946AL',TRUE, 'GUILDER', 'Beverwijk', 'FOOD');
--
insert into customer(id, password,username,first_name, last_name, email, area_code, enabled,user_role,  city,customer_guild)
values (5,'Giel','Giel','Giel', 'Bijwaard', 'giel@gmail.com', '1946AL',TRUE,'GUILDER','Beverwijk','FINANCE');
insert into customer(id,password,username,first_name, last_name, email, area_code, enabled, user_role, city, customer_guild )
values (6,'Miquel','Miquel','Miquel', 'Elshot', 'miquelio@yahoo.com', '1066SP',TRUE, 'GUILDER', 'Amsterdam', 'CONSTRUCTION');
insert into customer(id,password,username,first_name, last_name, email, area_code, enabled, user_role, city, customer_guild )
values (7,'Guno','Guno','Guno', 'Elshot', 'guno@yahoo.com', '1066SP',TRUE, 'GUILDER', 'Amsterdam', 'LEISURE');
insert into customer(id,password,username,first_name, last_name, email, area_code, enabled, user_role, city, customer_guild )
values (8,'Miles','Miles','Miles', 'Elshot', 'Miles@yahoo.com', '1946AL',TRUE, 'GUILDER', 'Amsterdam', 'SPORT');
insert into customer(id,password,username,first_name, last_name, email, area_code, enabled, user_role, city, customer_guild )
values (9,'Julian','Julian','Julian', 'Elshot', 'julian@yahoo.com', '1946AL',TRUE, 'GUILDER', 'Beverwijk', 'CREATIVE_DESIGN');
insert into customer(id,password,username,first_name, last_name, email, area_code, enabled, user_role, city, customer_guild )
values (10,'Doris','Doris','Doris', 'Komproe', 'Doris@yahoo.com', '1066SP',TRUE, 'GUILDER', 'Amsterdam', 'HEALTHCARE');
insert into customer(id,password,username,first_name, last_name, email, area_code, enabled, user_role, city, customer_guild )
values (11,'Atie','Atie','Atie', 'Bijwaard', 'atie@yahoo.com', '1946AL',TRUE, 'GUILDER', 'Amsterdam', 'SECURITY');
--
--
--
--
...
insert into items(name, price, description, number, count, item_type, customer_id)
values ('Air Jordan XI 25th Anniversary with Jumpman', 11000, 'To celebrate the 25th anniversary of the first Air Jordan released in 1985, Nike released a special edition of the Air Jordan XI', 02, 10, 'PRODUCT', 1);
--
insert into items(name, price, description, number, count, item_type, customer_id)
...
--
insert into items(name, price, description, number, count, item_type, customer_id)
values ('Nike Yeezy 2 Red October', 7500, 'Before Kanye West signed to adidas, the legendary Yeezy shoes used to be released under Nike.', 02, 10, 'PRODUCT', 1);
...
insert into items(name, price, description, number, count, item_type, customer_id)
values ('DJ Khaled x Air Jordan 3 ‘Grateful', 25000, 'When DJ Khaled released his album Grateful, his collaboration with Jordan – a pair of Air Jordan 3´s called “Grateful” also came out.', 02, 10, 'PRODUCT', 1);
...
insert into items(name, price, description, number, count, item_type, customer_id)
values ('Nike Air Mag Back to the Future 2016', 25000, 'One of recent year´s most famous sneakers – owned by, for example, the Slovakian rapper Rytmus.', 02, 10, 'PRODUCT', 1);
--
-- -- service
--
insert into items(name, price, description, number,count, item_type, customer_id)
...
insert into messages(title, body_text,customer_id, invoice_id)
values ('Yes it worked!','A confirmation of this relationship is modeled correctly',3,2);